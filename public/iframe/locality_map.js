...
function localityAreaColor(area) {
  switch (area) {
    ...
    case 'albany': return '#009900';
    case 'albuquerque': return '#660066'; 
    case 'atlanta': return '#ff3300';
    case 'austin': return '#3333cc';
    case 'birmingham': return '#01FFDD';
    ...
    case 'buffalo': return '#993399';
    case 'burlington': return '#0022AA';
    case 'charlotte':
    case 'hartford':
      return '#00ccff';

    case 'cleveland': return '#663300';
    case 'coloradoSprings': return '#ff9933';
    case 'columbus':
    case 'corpus': 
      return '#33cc33';

    case 'dallas': return '#ff99a8';
    case 'davenport':
    case 'hawaii':
    case 'kansasCity':
    case 'pittsburg':
    ...
    case 'harrisburg': return '#cccccc';
    case 'houston':
    case 'minneapolis':
      return '#9900cc';

    case 'huntsville': return '#cc0000';
    case 'indianapolis':
    case 'lasVegas':
    case 'richmond':
      return '#0000cc';
    ...
    case 'milwaukee': return '#802b00';
    case 'newYork':
    case 'omaha':
    case 'seattle': 
      return '#666699';

    case 'philadelphia': return '#009933';
    case 'portland': return '#003300';
    case 'raleigh': return '#6600cc';
    case 'sanAntonio': return '#000000';
    
    case 'sanJose': return '#ff99ff';
    case 'washington': return '#00ffff';
...
function markerType(fac) {
  switch (fac.type) {
    case 'Tower': return '#36AD56';
    case 'Tower and Approach Control': return '#FF7800';
    case 'Enroute Center': return '#F5E000';
    case 'Combined Control Facility': return '#002DF5';
    case 'Approach Control': return '#F50000';
...
(async () => {
  const markerData = await fetch('./fac_data.json')
    .then(res => res.json());
...
legend.onAdd = function(map) {
  ...
  for (let i = 0; i < types.length; i++) {
    ...
    div.innerHTML += 
      `<li><i style="background: ${markerType(obj)}"></i>${labels[i]}</li>`
  }
